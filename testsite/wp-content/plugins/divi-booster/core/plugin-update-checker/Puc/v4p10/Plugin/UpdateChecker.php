...
if ( !class_exists('\DiviBooster\Puc_v4p10_Plugin_UpdateChecker', false) ):
	...
	class Puc_v4p10_Plugin_UpdateChecker extends Puc_v4p10_UpdateChecker {
		...
		public function requestInfo($queryArgs = array()) {
			list($pluginInfo, $result) = $this->requestMetadata(__NAMESPACE__.'\\Puc_v4p10_Plugin_Info', 'request_info', $queryArgs);
