...
if ( !class_exists('\DiviBooster\Puc_v4p10_Theme_UpdateChecker', false) ):
	...
	class Puc_v4p10_Theme_UpdateChecker extends Puc_v4p10_UpdateChecker {
		...
		public function requestUpdate() {
			list($themeUpdate, $result) = $this->requestMetadata(__NAMESPACE__.'\\Puc_v4p10_Theme_Update', 'request_update');
