...
add_filter('db_pb_fullwidth_slider_content', 'db_pb_fullwidth_slider_filter_content', 10, 2);

function db_pb_fullwidth_slider_filter_content($content, $args) {
	return db_pb_slider_filter_content($content, $args, 'et_pb_fullwidth_slider');
}
