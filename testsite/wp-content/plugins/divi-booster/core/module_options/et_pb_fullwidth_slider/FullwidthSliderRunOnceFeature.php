...
class FullwidthSliderRunOnceFeature {
    ...
    public function init() {
        if (function_exists('add_filter')) {
            add_filter('dbmo_et_pb_fullwidth_slider_whitelisted_fields', array($this, 'appendFieldNames'));
            add_filter('dbmo_et_pb_fullwidth_slider_fields', array($this, 'appendFields'));
            add_filter('db_pb_fullwidth_slider_content', array($this, 'appendScript'), 10, 2);
        }
    }

    public function appendScript($content, $args) {
