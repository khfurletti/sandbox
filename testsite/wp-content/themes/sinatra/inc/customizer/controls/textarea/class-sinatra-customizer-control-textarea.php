<?php
/**
 * Sinatra Customizer custom textarea control class.
 *
 * @package     Sinatra
...
if ( ! class_exists( 'Sinatra_Customizer_Control_Textarea' ) ) :
	/**
	 * Sinatra Customizer custom select control class.
	 */
	class Sinatra_Customizer_Control_Textarea extends Sinatra_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="sinatra-control-wrapper sinatra-textarea-wrapper">
